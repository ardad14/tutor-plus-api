...
<!--                <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="1479" height="624" style="display: block; width: 1479px; height: 624px;"></canvas>-->
                <chart
...
export default {
    ...
    mounted () {
        this.renderChart(this.actionsData);
    },
}
</script>
